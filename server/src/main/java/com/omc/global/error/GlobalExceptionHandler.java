...
import com.omc.global.webhook.WebhookService;
...
public class GlobalExceptionHandler {
	...
	protected ResponseEntity<ErrorResponse> handleBindException(BindException e) throws IOException {
		log.error("handleBindException", e);
		ErrorResponse errorResponse = ErrorResponse.of(HttpStatus.BAD_REQUEST.toString(), e.getBindingResult());
		webhookService.sendErrorWebhook(e);
	...
	protected ResponseEntity<ErrorResponse> handleMethodArgumentTypeMismatchException(
		MethodArgumentTypeMismatchException e) throws IOException {
	...
	protected ResponseEntity<ErrorResponse> handleConflict(BusinessException e) throws IOException {
	...
	protected ResponseEntity<ErrorResponse> handleException(Exception e) throws IOException {
